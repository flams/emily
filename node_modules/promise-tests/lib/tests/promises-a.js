...
describe("[Promises/A] 1. Basic characteristics of `then`", function () {
...
describe("[Promises/A] 2. State transitions", function () {
...
describe("[Promises/A] 3. Chaining off of a fulfilled promise", function () {
...
describe("[Promises/A] 4. Chaining off of a rejected promise", function () {
...
describe("[Promises/A] 5. Chaining off of an eventually-fulfilled promise", function () {
    describe("when the first fulfillment callback returns a new value", function () {
        it("should call the second fulfillment callback with that new value", function (done) {
            var tuple = pending();
...
describe("[Promises/A] 6. Chaining off of an eventually-rejected promise", function () {
    describe("when the first rejection callback returns a new value", function () {
        it("should call the second fulfillment callback with that new value", function (done) {
            var tuple = pending();
            tuple.promise.then(null, function () {
...
describe("[Promises/A] 7. Multiple handlers", function () {
